        ...
        <section className="relative h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2">
              ...
              >
                An Electronic Engineer & Web Developer with a passion for
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                ...
                knack for creating innovative solutions. With a strong
                foundation in both hardware and software, I bring a unique
